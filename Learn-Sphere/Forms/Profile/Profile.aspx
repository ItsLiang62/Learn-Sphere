...
<head runat="server">
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-save-profile { font-family: 'Roboto', sans-serif; font-size: 0.88rem; font-weight: 700; background: linear-gradient(135deg,var(--accent),#7c6fff); color: #fff; border: none; border-radius: 10px; padding: 11px 28px; cursor: pointer; transition: 0.2s; width: 100%; }
        .btn-save-profile:hover { opacity: 0.88; transform: translateY(-1px); }
        .msg-success { color: #00856a; font-size: 0.85rem; font-weight: 600; margin-top: 10px; display: block; }

        .quick-link { display: flex; align-items: center; gap: 14px; padding: 14px 0; border-bottom: 1px solid var(--border); text-decoration: none; color: var(--ink); cursor: pointer; transition: 0.18s; background: none; border-left: none; border-right: none; border-top: none; width: 100%; text-align: left; font-family: 'Roboto', sans-serif; }
        .quick-link:last-child { border-bottom: none; }
        .quick-link:hover { color: var(--accent); }
        .quick-link:hover .ql-icon { background: var(--accent); color: #fff; }
        .ql-icon { width: 40px; height: 40px; border-radius: 10px; background: var(--surface); border: 1.5px solid var(--border); display: flex; align-items: center; justify-content: center; font-size: 1rem; flex-shrink: 0; transition: 0.18s; color: var(--accent); position: relative; }
        .ql-text strong { font-weight: 700; font-size: 0.9rem; display: block; }
        .ql-text span   { font-size: 0.78rem; color: var(--muted); }
        .ql-arrow { margin-left: auto; color: var(--muted); font-size: 0.75rem; }
        .unread-dot { position: absolute; top: -3px; right: -3px; width: 10px; height: 10px; border-radius: 50%; background: var(--accent2); border: 2px solid var(--card); display: none; }
        ...
        .mini-stat .ms-val   { font-size: 1.6rem; font-weight: 900; color: var(--ink); letter-spacing: -0.5px; }
...
<body>
    <form id="form1" runat="server">
            ...
            <div class="container hero-inner">
                <div class="d-flex align-items-center gap-4 flex-wrap">
                    ...
                    <div class="hero-user-info flex-grow-1">
                        ...
                        <p class="bio"><asp:Label ID="lblBioPreview" runat="server" Text="No bio yet."></asp:Label></p>
                    </div>
                    <asp:Button ID="btnLogout" runat="server" Text="⏏ Sign Out"
                        CssClass="btn-logout" OnClick="btnLogout_Click"
                        OnClientClick="return confirm('Sign out of LearnSphere?');" />
                </div>
            </div>
        </div>
                ...
                <div>
                    <div class="p-card">
                        ...
                        <div class="p-card-body">
                            ...
                            <asp:TextBox ID="txtBio"      runat="server" CssClass="form-field" TextMode="MultiLine" placeholder="Tell others about yourself…" />
                    ...
                    <div class="p-card">
                        ...
                        <div class="p-card-body">
                            <div class="mini-stats">
                                <div class="mini-stat">
                                    <div class="ms-val"><asp:Label ID="lblStatAttempts" runat="server" Text="0"></asp:Label></div>
                                    <div class="ms-label">Quiz Attempts</div>
                                </div>
                                <div class="mini-stat">
                                    <div class="ms-val"><asp:Label ID="lblStatSaved" runat="server" Text="0"></asp:Label></div>
                                    <div class="ms-label"><asp:Label ID="lblStatSavedLabel" runat="server" Text="Saved Quizzes"></asp:Label></div>
                                </div>
                                <div class="mini-stat">
                                    <div class="ms-val"><asp:Label ID="lblStatQuizzes" runat="server" Text="0"></asp:Label></div>
                                    <div class="ms-label"><asp:Label ID="lblStatQuizzesLabel" runat="server" Text="Quizzes Taken"></asp:Label></div>
                                </div>
                                <div class="mini-stat">
                                    <div class="ms-val"><asp:Label ID="lblStatAvg" runat="server" Text="—"></asp:Label></div>
                ...
                <div>
                    <div class="p-card">
                        ...
                        <div class="p-card-body" style="padding:8px 24px;">
                            ...
                            <%-- Saved Quizzes — learner + educator only (hidden for admin via JS) --%>
                            ...
                            <%-- Analytics — all roles, description varies by role --%>
                    ...
                    <div class="p-card">
                        ...
                        <div class="p-card-body">
                            <p style="font-size:0.85rem;color:var(--muted);margin-bottom:8px;">
                                ...
                                Member since <strong style="color:var(--ink)"><asp:Label ID="lblMemberSince" runat="server" Text="—"></asp:Label></strong>
                            </p>
                            <p style="font-size:0.85rem;color:var(--muted);">
                                <i class="fa-regular fa-envelope me-2"></i>
                                <asp:Label ID="lblEmailInfo" runat="server" Text=""></asp:Label>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <asp:HiddenField ID="hfHandlerUrl" runat="server" Value="" />
